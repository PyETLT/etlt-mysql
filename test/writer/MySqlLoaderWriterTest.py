...
class MySqlLoaderWriterTest(unittest.TestCase):
    ...
    def test_types(self):
        ...
        writer.fields = ['bool', 'date', 'datetime', 'timedelta', 'decimal', 'empty', 'float', 'int', 'none', 'str',
                         'uuid']
        rows = [{
                        'bool':      False,
        ...
        #  @todo test strings with tabs and EOL  #  @todo test with lading and selecting data from actual MySQL database
